        ...
        >
          <div>
            ...
            <div className="page-subtitle">
              New alerts are suppressed for the selected device (or all devices) while a window is
              active. Open alerts still resolve normally.
            </div>
          </div>
                ...
                <tr key={w.id}>
                  ...
                  <td>
                    <span className={`badge ${isActive(w) ? 'badge-warning' : ''}`}>
                      {isActive(w)
                        ? 'Active'
                        : new Date(w.start_at).getTime() > Date.now()
                          ? 'Scheduled'
                          : 'Ended'}
                    </span>
                  </td>
          ...
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleCreate}>
              ...
              <div className="form-group">
                ...
                <input
                  className="input"
                  placeholder="e.g. firmware upgrade"
                  value={form.reason}
