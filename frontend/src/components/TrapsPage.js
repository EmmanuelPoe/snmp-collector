...
export default function TrapsPage() {
  ...
  const rangeLabel =
    hours === 1 ? '1 hour' : hours < 24 ? `${hours} hours` : hours === 24 ? '24 hours' : '7 days';
          ...
          <tbody>
            ...
            {!loading && traps.length === 0 && (
              <tr>
                ...
                >
                  No traps received in the last {rangeLabel}. Enable <code>TRAP_ENABLED=true</code>{' '}
                  on the agent to start receiving traps.
                </td>
              </tr>
            )}
            {!loading &&
