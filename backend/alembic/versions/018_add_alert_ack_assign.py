...
def upgrade() -> None:
    ...
    op.create_foreign_key("fk_alerts_acknowledged_by_users", "alerts", "users", ["acknowledged_by"], ["id"])
    op.create_foreign_key("fk_alerts_assigned_to_users", "alerts", "users", ["assigned_to"], ["id"])
