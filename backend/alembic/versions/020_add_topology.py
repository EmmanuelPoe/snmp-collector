...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('local_device_id', sa.Integer(), sa.ForeignKey('devices.id', ondelete='CASCADE'), nullable=False, index=True),
        ...
        sa.Column('remote_device_id', sa.Integer(), sa.ForeignKey('devices.id', ondelete='SET NULL'), nullable=True, index=True),
